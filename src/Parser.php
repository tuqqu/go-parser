...
use GoParser\{
    ...
    Ast\Expr\BinaryExpr,
    Ast\Expr\CallExpr,
    Ast\Expr\ChannelType,
    Ast\Expr\CompositeLit,
    Ast\Expr\Expr,
    Ast\Expr\FloatLit,
    Ast\Expr\FullSliceExpr,
    Ast\Expr\FuncLit,
    Ast\Expr\FuncType,
    Ast\Expr\GroupExpr,
    Ast\Expr\Ident,
    ...
    Ast\Expr\Operand,
    Ast\Expr\ParenType,
    Ast\Expr\PointerType,
    Ast\Expr\PrimaryExpr,
    Ast\Expr\QualifiedTypeName,
    Ast\Expr\RawStringLit,
    Ast\Expr\RuneLit,
    Ast\Expr\SelectorExpr,
    Ast\Expr\SimpleSliceExpr,
    Ast\Expr\SingleTypeName,
    Ast\Expr\SliceExpr,
    Ast\Expr\SliceType,
    Ast\Expr\StringLit,
    Ast\Expr\StructType,
    Ast\Expr\Type,
    Ast\Expr\TypeAssertionExpr,
    Ast\Expr\TypeElem,
    Ast\Expr\TypeName,
    Ast\Expr\TypeTerm,
    Ast\Expr\UnaryExpr,
    Ast\Expr\UnderlyingType,
    Ast\ExprCaseClause,
    Ast\ExprList,
    Ast\ExprSwitchCase,
    Ast\FieldDecl,
    ...
    Ast\Stmt\EmptyStmt,
    Ast\Stmt\ExprStmt,
    Ast\Stmt\ExprSwitchStmt,
    Ast\Stmt\FallthroughStmt,
    Ast\Stmt\ForStmt,
    Ast\Stmt\FuncDecl,
    Ast\Stmt\GoStmt,
    Ast\Stmt\GotoStmt,
    ...
    Ast\Stmt\SelectStmt,
    Ast\Stmt\SendStmt,
    Ast\Stmt\ShortVarDecl,
    Ast\Stmt\SimpleStmt,
    Ast\Stmt\Stmt,
    Ast\Stmt\SwitchStmt,
    Ast\Stmt\TypeDecl,
    Ast\Stmt\TypeSwitchStmt,
    Ast\Stmt\VarDecl,
    Ast\StmtList,
    Ast\TypeCaseClause,
    Ast\TypeDef,
